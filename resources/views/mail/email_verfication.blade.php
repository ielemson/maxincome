                        ...
                        <tbody>
                            ...
                            <tr>
                                <td style="padding: 0 30px 20px">
                                    ...
                                    <a href="http://{{env('MAIL_SENDER')}}/registration/confirm/{{$data['username']}}/{{$data['token']}}" style="background-color:#ff3722;border-radius:4px;color:#ffffff;display:inline-block;font-size:13px;font-weight:600;line-height:44px;text-align:center;text-decoration:none;text-transform: uppercase; padding: 0 30px">Verify Email</a>
                                </td>
                            </tr>
                            <tr>
                                <td style="padding: 0 30px">
                                    ...
                                    <a href="https://{{env('MAIL_SENDER')}}/registration/confirm/{{$data['username']}}/{{$data['token']}}" style="color: #ff3722; text-decoration:none;word-break: break-all;">https://{{env('MAIL_SENDER')}}/registration/confirm/{{$data['username']}}/{{$data['token']}}</a>
                                </td>
                            </tr>
                            <tr>
