    ...
    <div class="auto-container">
        ...
        <div class="separate"></div>
                ...
                <div class="styled-form login-form">
                  ...
                  <form method="POST" action="<?php echo e(route('reset_password')); ?>">
                    <?php echo csrf_field(); ?>
                    
                        <div class="form-group">
                            <span class="adon-icon"><span class="fa fa-envelope-o"></span></span>
                            <input type="email" name="email" value="" placeholder="Emai Address*" class="form-control <?php $__errorArgs = ['email'];
...
</html><?php /**PATH C:\Users\ielemson\Desktop\Apps\Laravel\maxincome\resources\views/auth/passwords/email.blade.php ENDPATH**/ ?>