                ...
                <div class="content">
                  ...
                  <form method="POST" action="<?php echo e(route('reset_user_pass',$token)); ?>">
                    ...
                    <div class="form-group">
                      <input id="login-username" type="password" name="password" required data-msg="Password" class="input-material <?php $__errorArgs = ['password'];
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="form-group">
                      ...
                      <label for="login-password" class="label-material"><?php echo e(__('Confirm New Password')); ?></label>
                      <?php $__errorArgs = ['password'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <a href="<?php echo e(route('login')); ?>"  class="btn btn-warning">Back To Login</a>
                  </form>
                </div>
              </div>
            </div>
...
</html><?php /**PATH C:\Users\ielemson\Desktop\Apps\Laravel\maxincome\resources\views/auth/passwords/reset.blade.php ENDPATH**/ ?>